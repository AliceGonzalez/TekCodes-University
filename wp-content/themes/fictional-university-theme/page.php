<?php
  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <?php
        //VAriable gets the ID of parent element or page
     ...
     if($theParent or $testArray) { ?>
      <div class="page-links">
        ...
        <ul class="min-list">
            ...
            //Arguments of function below needs an associate array
            wp_list_pages(array(
                //Hides title
                'title_li' => NULL,
                //Show liks of childrens page only
                'child_of' => $findChildrenOf,
                //Menu order option on UI
